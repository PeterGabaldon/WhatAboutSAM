...
WorkCallbackNtQueryValueKey:
    ...
    mov r8d, [rbx + 0x18]       ; KEY_VALUE_INFORMATION_CLASS KeyValueInformationClass
    mov r9, [rbx + 0x1c]        ; PVOID KeyValueInformation
    mov r10d, [rbx + 0x24]      ; ULONG Length
    mov [rsp+0x28], r10d        
...
WorkCallbackNtEnumerateValueKey:
    ...
    mov rcx, [rbx + 0x8]        ; PHANDLE KeyHandle
    mov edx, [rbx + 0x10]       ; ULONG Index; 
    mov r8d, [rbx + 0x14]       ; KEY_VALUE_INFORMATION_CLASS KeyValueInformationClass
    mov r9, [rbx + 0x18]        ; PVOID KeyValueInformation
    mov r10d, [rbx + 0x20]      ; ULONG Length
    mov [rsp+0x28], r10d         
